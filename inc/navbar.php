            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  <li class="<?php if($pageTitle == "home"){ echo "active";} ?>"><a href="<?php echo BASE_URL;?>pages/admin/index.php"><i class="fa fa-dashboard "></i> Dashboard </a>
                  </li>
                  <li class="<?php if($pageTitle == "contributions" || $pageTitle == "requests"){ echo "active";} ?>"><a><i class="fa fa-info-circle"></i> Options <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?php echo BASE_URL;?>pages/admin/requests.php">View loan Request</a></li>
                      <li><a href="<?php echo BASE_URL;?>pages/admin/contributions.php">View Contribution</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
